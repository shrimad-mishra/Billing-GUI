...
class Bill_App:
    def __init__(self,root):
        ...
        #Title of App
        title = Label(self.root,text = "Shrimad Billing Software",bd = 12,relief = GROOVE,fg = fg_color,bg = bg_color,font=("times new roman",30,"bold"),pady = 3).pack(fill = X)
        ...
        #===========
        bill_title = Label(F3,text = "Shrimad Bill Area",font = ("Lucida",13,"bold"),bd= 7,relief = GROOVE)
...
#Function For Text Area
    def welcome_soft(self):
        ...
        self.txt.insert(END,"       Welcome To Shrimad Retail\n")
